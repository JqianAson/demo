...
public class AesUtil {
    ...
    public static void  main(String[] args) throws Exception {
        ...
        log.info("key:{}", key);
        String en = encrypt("SC20222120701","ABCDEFGHIJKLMNOPQRSTUVWXYZ012345");
        String path = "www.baidu.com/";
        //System.out.println("加密后的结果："+en);
        log.info("加密后的结果:{}", path+en);
        //System.out.println(decrypt(en,key));
//        log.info(decrypt(en,key));

        String value = decrypt(en, "ABCDEFGHIJKLMNOPQRSTUVWXYZ012345");
